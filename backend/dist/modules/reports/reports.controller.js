...
let ReportsController = class ReportsController {
    ...
    getWeeklyReport(startDate, classId) {
        return this.reportsService.getWeeklyReport(startDate, classId);
    }
    getMonthlyReport(month, year, classId) {
...
__decorate([
    ...
    (0, roles_guard_1.Roles)(user_entity_1.UserRole.ADMIN, user_entity_1.UserRole.TEACHER, user_entity_1.UserRole.STUDENT),
